...
교육 원리
  ...
  · 양순음(1: ㅂ/ㅃ/ㅍ/ㅁ)은 입술 닫힘이라 잘 보이지만 서로 구별 불가(동구형이음).
...
VISEME_LESSONS: List[Dict] = [
    {
        ...
        "phonemes": ["ㅂ", "ㅃ", "ㅍ", "ㅁ"], "visibility": "high",
        "look": "두 입술을 완전히 붙였다 뗀다. 닫히는 순간이 뚜렷이 보인다.",
        "teach": "잘 보이지만 ㅂ·ㅃ·ㅍ·ㅁ 서로는 똑같아 구별 못 한다(동구형이음). '입술이 닫혔다'까지만 읽고 나머지는 문맥으로.",
...
HOMOPHENE_CLUSTERS: List[Dict] = [
    {
        ...
        "note": "ㅂ·ㅃ·ㅍ·ㅁ은 입술이 닫혀 겉으로는 똑같이 보인다. 무리 안 구별은 문맥으로.",
    },
    {
...
CLOSURE_ITEMS = [
    {"id": "c1", "display": "___을 먹었어요", "answer": "밥", "options": ["밥", "맘", "밤"], "hint": "'먹다'와 어울리는 건?"},
