...
> **2026-09-24 아침 — GPU 세션 2·3 결과와 결정할 것.**
...
> - **608:** TS02를 두 번 끝까지 받았지만 0개(1차는 고른 세션이 TS02에 없음, 2차는 범주 28 wav가 deflate라 건너뜀). 풀기를 더해
>   08:20부터 4차로 받고, 오면 세션 5(608 측정·kNN-VC)가 자동으로 돈다(`liplab-lab/tools/pod/stream4_then_s5.sh`).
> - **조음 역추정 mm 오차(4.2-13):** 세션 3은 파드에 unzip이 없어 실패, 세션 4에서 파이썬 zipfile로 다시(진행 중).
