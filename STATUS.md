...
> **2026-09-26: liplab-dev 콜드 스타트 측정과 개선(코드·설정만, 배포 안 함), 4단계 '학습 시작하기' 수정(f53fc31, 배포 안 함).**
...
>   `LIPLAB_UI_HANDOFF.md` §6-8. 배포 안 함.
...
> - 남은 사용자 몫: "배포해"(liplab-dev, 위 두 가지를 함께 올림). 그 밖은 9/25 목록과 같다.
